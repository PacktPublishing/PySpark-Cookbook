...
# Create Spark Context with four working threads (note, `local[4]`)
sc = SparkContext("local[4]", "StatefulNetworkWordCount")
...
# Wait for the computation to terminate (e.g. <Ctrl><C>)
